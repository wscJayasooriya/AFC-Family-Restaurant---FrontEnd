...
@Component({
  selector: 'app-western-cuisine',
  templateUrl: './western-cuisine.component.html',
  styleUrls: ['./western-cuisine.component.css']
})
export class WesternCuisineComponent implements OnInit {
