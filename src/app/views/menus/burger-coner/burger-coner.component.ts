...
@Component({
  selector: 'app-burger-coner',
  templateUrl: './burger-coner.component.html',
  styleUrls: ['./burger-coner.component.css']
})
export class BurgerConerComponent implements OnInit {
